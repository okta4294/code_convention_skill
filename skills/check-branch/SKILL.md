---
name: check-branch
description: Memvalidasi atau menyusun format penamaan Git branch sesuai alur kerja repositori, hierarki modul, dan kategori (<kategori>/<nama-modul>/<deskripsi-fitur>). Trigger dengan /check-branch.
---
