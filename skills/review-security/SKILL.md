...
description: Melakukan audit khusus keamanan aplikasi (Secured Programming) untuk mendeteksi kerentanan SQL Injection, sanitasi parameter $_GET, ID download, dan celah upload berkas. Trigger dengan /review-security atau saat audit keamanan kode diminta.
---
