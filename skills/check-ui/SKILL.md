---
name: check-ui
description: Memeriksa kepatuhan antarmuka UI/UX (layout form vertikal, hierarki tombol, warna tombol biru/merah/netral, letak navigasi, dan konsistensi bahasa). Trigger dengan /check-ui.
---
